...
export const MILES_CLUBS: MilesClub[] = [
    {
        ...
        program: 'Smiles',
        color: '#FF6B00',
        monthlyFee: 'A partir de ~R$ 46/mês',
        signupUrl: 'https://www.smiles.com.br/clube-smiles',
        description: 'Assinatura mensal da Smiles com milhas garantidas todo mês + bônus diferencial por plano em promoções de transferência',
        tiers: [
            { name: 'Plano 1.000', monthlyFee: '~R$ 46/mês · 1.000 mi', bonusLabel: 'Bônus diferencial em promos (ex: 70%)' },
            { name: 'Plano 2.000', monthlyFee: '~R$ 82/mês · 2.000 mi', bonusLabel: 'Bônus diferencial em promos (ex: 80%)' },
            { name: 'Plano 5.000', monthlyFee: '~R$ 184/mês · 5.000 mi', bonusLabel: 'Bônus diferencial em promos' },
            { name: 'Plano 7.000', monthlyFee: '~R$ 255/mês · 7.000 mi', bonusLabel: 'Bônus diferencial em promos' },
            { name: 'Plano 10.000', monthlyFee: '~R$ 340/mês · 10.000 mi', bonusLabel: 'Bônus diferencial + benefícios Diamante' },
            { name: 'Plano 20.000', monthlyFee: 'Anual · 20.000 mi · Diamante', bonusLabel: 'Máximo bônus em promos + status Diamante' },
        ],
        benefits: [
            ...
            'Plano 20k: status Diamante + bônus máximo em campanhas',
        ],
    },
    {
        ...
        program: 'TudoAzul',
        color: '#003DA5',
        monthlyFee: 'A partir de ~R$ 42/mês (anual)',
        signupUrl: 'https://www.voeazul.com.br/br/pt/ofertas/adesao-clube',
        description: 'Assinatura do Clube Azul com pontos mensais garantidos + bônus progressivo por tempo de assinatura',
        tiers: [
            { name: 'Clube 1.000', monthlyFee: '~R$ 42/mês (anual) · 1.000 pts', bonusLabel: 'Bônus progressivo por tempo de assinatura' },
            { name: 'Clube 2.000', monthlyFee: '~R$ 80/mês (anual) · 2.000 pts', bonusLabel: 'Bônus progressivo por tempo de assinatura' },
            { name: 'Clube 5.000', monthlyFee: '~R$ 174/mês (anual) · 5.000 pts', bonusLabel: 'Bônus progressivo por tempo de assinatura' },
            { name: 'Clube 10.000', monthlyFee: '~R$ 344/mês (anual) · 10.000 pts', bonusLabel: 'Bônus progressivo por tempo de assinatura' },
            { name: 'Clube 20.000', monthlyFee: '~R$ 762/mês (anual) · 20.000 pts', bonusLabel: 'Bônus máximo + campanhas Livelo 133%' },
        ],
        benefits: [
    ...
    },
    {
        ...
        description: 'Status de elite da LATAM obtido por pontos de qualificação (QV) em voos — concede bônus de acúmulo e benefícios premium',
        tiers: [
            { name: 'Gold', monthlyFee: 'QV mínimo anual', bonusLabel: '+50% em acúmulo de pontos por voo' },
            { name: 'Platinum', monthlyFee: 'QV intermediário anual', bonusLabel: '+75% em acúmulo + benefícios Platinum' },
            { name: 'Black', monthlyFee: 'QV alto anual', bonusLabel: '+100% em acúmulo + lounges LATAM' },
            { name: 'Black Signature', monthlyFee: 'QV máximo anual', bonusLabel: '+125% em acúmulo + benefícios premium' },
        ],
        benefits: [
            'Bônus de 50 a 125% em acúmulo de pontos por voo',
            'Acesso a lounges LATAM (Platinum/Black)',
    ...
    {
        id: 'latam_pass_clube',
        name: 'Clube LATAM Pass',
        program: 'LATAM Pass',
        color: '#C00010',
        monthlyFee: 'A partir de R$ 40,90/mês',
        signupUrl: 'https://latampass.latam.com/pt_br/clube/precos-e-planos',
        description: 'Assinatura paga do Clube LATAM Pass com pontos mensais + add-ons modulares (Mais, Embarque, Acelere, Turbo)',
        tiers: [
            { name: 'Base', monthlyFee: 'R$ 40,90/mês', bonusLabel: 'Pontos mensais base + benefícios clube' },
            { name: 'Base + Mais', monthlyFee: 'R$ 78,80/mês', bonusLabel: 'Base + pontos adicionais Mais' },
            { name: 'Base + Embarque', monthlyFee: 'R$ 90,80/mês', bonusLabel: 'Base + benefícios de embarque' },
            { name: 'Base + Acelere', monthlyFee: 'R$ 187,80/mês', bonusLabel: 'Base + acelerador de pontos' },
            { name: 'Base + Turbo', monthlyFee: 'R$ 356,80/mês', bonusLabel: 'Base + máximo pontos mensais' },
        ],
        benefits: [
            'Pontos mensais garantidos conforme o plano',
            'Acesso a benefícios modulares (Mais, Embarque, Acelere, Turbo)',
            'Pontos não expiram com clube ativo',
            'Combinável com status de elite LATAM',
        ],
    },
    {
        id: 'livelo_clube',
        ...
        tiers: [
            ...
            { name: 'Clube Super', monthlyFee: 'R$ 299,90/mês · 7.000 pts', bonusLabel: 'Pontos mensais + benefícios clube' },
            { name: 'Clube Mega', monthlyFee: 'R$ 499,90/mês · 12.000 pts', bonusLabel: 'Pontos mensais + benefícios clube' },
            { name: 'Clube Top', monthlyFee: 'R$ 799,90/mês · 20.000 pts', bonusLabel: 'Máximo benefícios + bônus exclusivos' },
        ],
        benefits: [
    ...
    },
    {
        ...
        program: 'Esfera',
        color: '#EC0000',
        monthlyFee: 'A partir de R$ 14,90/mês',
        signupUrl: 'https://www.esfera.com.vc/clube',
        description: 'Assinatura do Clube Esfera com pontos mensais garantidos e benefícios progressivos por plano',
        tiers: [
            { name: 'Essencial', monthlyFee: 'R$ 14,90/mês · 100 pts', bonusLabel: 'Pontos mensais + uso Esfera' },
            { name: 'Pro', monthlyFee: 'R$ 43,90/mês · 1.000 pts', bonusLabel: 'Pontos mensais + uso Esfera' },
            { name: 'Master', monthlyFee: 'R$ 106,90/mês · 2.500 pts', bonusLabel: 'Pontos mensais + uso Esfera' },
            { name: 'VIP', monthlyFee: 'R$ 211,90/mês · 5.000 pts', bonusLabel: 'Pontos mensais + uso Esfera' },
            { name: 'Premium', monthlyFee: 'R$ 414,90/mês · 10.000 pts', bonusLabel: 'Pontos mensais + uso Esfera' },
            { name: 'Exclusive', monthlyFee: 'R$ 799,90/mês · 20.000 pts', bonusLabel: 'Máximo pontos + benefícios exclusivos' },
        ],
        benefits: [
            'Pontos Esfera mensais garantidos conforme o plano',
            'Transferências para Smiles, LATAM Pass, Azul e parceiros internacionais',
            '20% de bônus permanente em transferências para Smiles (cartão Santander)',
            'Pontos acumulam em todas as compras',
